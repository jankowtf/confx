...
When I said *regular R expressions*, this does not yet reflect the full picture as I started with simple expressions as defined in `valid_operators_logical()`
